            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <div className='usename_modal'>
                        ...
                        <Button className='usename_modal1_btn' style={{ background: "#4b7a7c", border: "none" }}>TRANSUNION</Button>
                        <Button className='usename_modal1_btn' style={{ background: "#4b7a7c", border: "none" }}>EXPERIAN</Button>
                        <Button className='usename_modal1_btn' style={{ background: "#4b7a7c", border: "none" }}>EQUIFAX</Button>
                    </div>
                </Modal.Body>
            </Modal>
            <Container>
                <Row>
                    <Col lg={12}>
                        <div className='mt-5 disputeletter_btn'>
                            <Button onClick={handleShow} style={{ background: "#4b7a7c", border: "none" }}>CREATE TRANSUNION DISPUTE</Button>
                        </div>
                    </Col>
                </Row>
                </Container>
